...
public class FBClientHandlerImpl implements FacebookClientHandler {
	...
	public String publishPhotoToWall(String token, String text, String image, boolean isLink) {
		try {
			 ...
			 * ByteArrayInputStream(decodedImageArray); BufferedImage images =
			 * ImageIO.read(bis); bis.close();
			 */
			publishResponse = facebookClient.publish(
					ChallengeConstants.FB_USER + ChallengeConstants.FB_POST_SEPARATOR + ChallengeConstants.FB_PHOTO,
					FacebookType.class,
					// BinaryAttachment.with("rivals.png",
					// getClass().getResourceAsStream("/rivals.png")),
					BinaryAttachment.with("test.png", decodedImageArray, "image/png"),
					Parameter.with(text, "Rivalry Started"));
	...
	/*public static void main(String[] args) {
		new FBClientHandlerImpl().publishPhotoToWall(
				"CAAXzorEpPMcBAFSdZBtaZBlwfuX8TZCpd3iyGQ6gP2XUBvAVRhLQZCxUGoPchXZARk4KY3dbVb9hQEFqhScns3Dz7jaNgNUJGTzQI23fcUi1n4Ljovolf0jrPlGw1iZCSmGVKeDgyxqa3hKM5oiAlmZAQYXO8xQZAApjYjZAFST4K6p3xAJpgpfzQgGFEwS17600ZD",
				"nothing",
